...
class Answer {
    ...
    public Answer(String s) {
        ...
        scnr.nextLine();
        this.grid = new Grid(gridSize, gridSize, scnr.nextLine());
        this.grid2 = new Grid(gridSize, gridSize, scnr.nextLine());
        this.grid3 = new Grid(gridSize, gridSize, scnr.nextLine());
    }
